...
export default function Details() {
  ...
  useEffect(() => {
    console.log("toprates changed:", toprates);
  }, [toprates]);
  ...
  const handleRatingSubmittest = async (selectedRate) => {
    ...
    try {
      ...
      if (res.ok) {
        product.averagerate = data.averagerate;
        product.ratecount = data.ratecount;

        togglePopup(`Thanks! You rated this product ${selectedRate} stars`);
      } else {
        console.warn("Failed:", data.msg);
      }
    } catch (err) {
  ...
  return (
    <div className={`${theme ? "" : "bg-dark"}`}>
        ...
        <div className="ms-5 row">
          ...
          <div className="col-md-4">
            <img
              ...
              src={mainImage}
              alt={product.name}
              style={{ height: "542px", objectFit: "cover" }}
          ...
          <div className="col-md-7 ps-5">
            ...
            <div className="d-flex align-items-baseline">
                ...
                {[5, 4, 3, 2, 1].map((star) => (
                  <span key={star}>
                    <input
                      ...
                      id={`star${star}`}
                      value={star}
                      checked={(userRating ?? product.averagerate) === star}
                      onChange={() => handleRatingSubmittest(star)}
                      className="d-none"
                    />
                    <label htmlFor={`star${star}`}>
                      <svg
                        ...
                        style={{
                          color:
                            (userRating ?? product.averagerate) >= star
                              ? "gold"
                              : "gray",
                        }}
                      >
              ...
              <span
                className="d-inline-block gray ps-2 ms-2 mt-1"
                style={{ borderLeft: "2px solid var(--gray)" }}
              >
                <span id="rating-value">{product.averagerate || 0}</span>{" "}
                Customers Reviews
              </span>
              <span
                className="d-inline-block gray ps-2 ms-2 mt-1"
                style={{ borderLeft: "2px solid var(--gray)" }}
              >
                <span id="rating-value">{product.ratecount || 0}</span>{" "}
                Customers
              </span>
            </div>
              ...
              {["l", "xl", "xs"].map((size) => (
                <span
                  ...
                  onClick={() => {
                    ...
                    SelectOrColor(product.id, "size", size);
                  }}
                >
                  {size}
                </span>
              ...
              {["mediumslateblue", "black", "#B88E2F"].map((color, index) => (
                <svg
                  ...
                  onClick={() => {
                    ...
                    SelectOrColor(product.id, "color", color);
                  }}
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <div className="row mb-3 align-items-start">
              <div className="col-md-2 text-secondary">
                {" "}
                {["SKU", "Category", "Tags", "Share"].map((label) => (
                  <p key={label} className="mb-2 fw-semibold">
                    {label}
                  </p>
                ))}
              </div>
              ...
              <div className="col-md-6 text-secondary">
                ...
                <div className="d-flex align-items-center gap-3 mt-1">
                  <svg
                    className="share-icon twitter text-black cursor-pointer"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                  ...
                  <svg
                    className="share-icon whatsapp text-black cursor-pointer"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
                  ...
                  <svg
                    className="share-icon facebook text-black  cursor-pointer"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
      ...
      <hr />
      <h2 className="text-center fw-bold my-5">Top Reviews</h2>
      <div className="row mx-3">
        {toprates
          .filter(
            (rating) => rating.user && rating.user.name && rating.user.image
          )
          .map((rating, index) => (
            <div key={index} className="col-md-6 mb-4">
              <div className="p-4 rounded-4 shadow-sm border my-bg-light my-text-black h-100 position-relative">
                <div
                  className="position-absolute"
                  style={{ top: "10px", right: "12px", opacity: 0.7 }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M7 8H4c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v3c0 .55-.45 1-1 1m6 0h-3c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v3c0 .55-.45 1-1 1"
                    />
                    <path
                      fill="none"
                      stroke="currentColor"
                ...
                <div className="d-flex align-items-center mb-3">
                  <img
                    ...
                    width={60}
                    height={60}
                    style={{ objectFit: "cover", border: "2px solid #B88E2F" }}
                  />
                  <div className="flex-grow-1">
                    <h6 className="mb-0 fw-semibold">{rating.user.name}</h6>
                    ...
                    <div className="d-flex mt-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <svg
                          ...
                          viewBox="0 0 20 20"
                          style={{
                            color: star <= rating.rate ? "gold" : "gray",
                          }}
                        >
                          <path
                            fill="currentColor"
                ...
                <blockquote
                  className="fst-italic mt-3 mb-0 my-text-gray border-start border-4 ps-3"
        ...
        <section className="gray p-5 m-5 mb-3 mt-0">
          ...
          <div className="mx-5 mt-5 row">
            <div className="col-md-6">
              <img
                className="img-fluid"
                src="https://res.cloudinary.com/dutetsivc/image/upload/v1759269253/furniro/g.png"
                alt=""
              />
            </div>
            <div className="col-md-6">
              <img
                className="img-fluid"
                src="https://res.cloudinary.com/dutetsivc/image/upload/v1759269253/furniro/Group 107.png"
                alt=""
              />
            </div>
          </div>
