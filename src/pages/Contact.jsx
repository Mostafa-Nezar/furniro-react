...
<div className="validation p-5 m-5">
  ...
  <p className="text-center text-black-50">
    For more information about our products & services, please feel free to drop us an email. Our staff will always be there to help you. Do not hesitate!
  </p>
</div>

<div className="row">
  <div className="col-md-6 p-5 pe-md-0 fieldsx mb-5">
    <div>
      <div className="mb-5">
        ...
        <span>
          <span>Address</span>
          <p className="ml-4">
            236 5th SE Avenue, <br /> New York, NY 10000, <br /> United States
          </p>
        </span>
      </div>
      ...
      <div className="my-5">
        ...
        <span>
          <span>Phone</span>
          <p className="ml-4">Mobile: +(84) 546-67895 <br /> Hotline: +(84) 456-67895</p>
        </span>
      </div>
      ...
      <div>
        ...
        <span>
          ...
          <p className="ml-4">Monday-Friday: 9:00 - 22:00 <br /> Saturday-Sunday: 9:00 - 21:00</p>
        </span>
      </div>
    </div>
  </div>
  ...
  <div className="col-md-6 p-5 ps-md-0 fields">
    <div>
      ...
      <br />
      <input type="text" className="namefield" name="name" placeholder="Abc" />
    </div>
    <div>
      <label>Email address</label>
      <br />
      <input type="email" className="mailfield" name="mail" placeholder="example@mail.com" />
    </div>
    <div>
      <label>Message</label>
      <br />
      <input type="text" className="messagefield" name="message" placeholder="Hi! I'd like to ask about..." />
    </div>
    <div>
      <label>Subject</label>
      <br />
      <input type="text" className="subjectfield" name="subject" placeholder="Hi! I'd like to ask about..." />
    </div>
