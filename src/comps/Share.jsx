...
//           <p className="text-black-50 text-center mt-2">Share Your fav product</p>
//         </div>
...
import { useAppContext } from "../tasks/MyContext"; // تأكد من المسار الصحيح
const ShareButtons = () => {
  const projectTitle = encodeURIComponent("Check out this project!");
  const { show } = useAppContext(); // استهلاك show من الكونتكست
  const setView = useAppContext().setView; // استخدام setView من AppContext
